      ...
      <div className="flex bg-[#cfe5ff]">
        <div className="mt-50 mx-auto flex max-[744px]:flex-col max-[744px]:mt-16 max-[744px]:w-full max-[744px]:px-8 max-[465px]:mt-10 max-[465px]:px-4">
          <div className="flex items-start justify-center flex-col">
            <p className="inline text-gray-700 text-[40px] font-bold leading-[140%] mt-3 max-[744px]:text-[32px] max-[465px]:text-2xl">
              일상의 모든 물건을
              <br />
              거래해 보세요
            </p>
      ...
      <div className="flex justify-center items-center">
        <div className="flex flex-row gap-16 w-full h-auto my-34.5 max-[744px]:flex-col max-[744px]:my-18 max-[744px]:px-8 max-[744px]:gap-8 max-[465px]:my-10 max-[465px]:px-4 max-[465px]:gap-6">
          ...
          <div className="flex items-start justify-center flex-col">
            ...
            <p className="inline text-gray-700 text-2xl font-medium leading-8 mt-6 max-[744px]:text-xl max-[465px]:text-base">
              가장 HOT한 중고거래 물품을
              <br />
              판다 마켓에서 확인해 보세요
            </p>
      ...
      <div className="flex justify-center items-center">
        <div className="flex flex-row gap-16 w-full h-auto my-34.5 max-[744px]:flex-col max-[744px]:my-18 max-[744px]:px-8 max-[744px]:gap-8 max-[465px]:my-10 max-[465px]:px-4 max-[465px]:gap-6">
          <div className="flex justify-center flex-col items-end max-[744px]:items-start">
            ...
            <p className="inline text-right text-gray-700 text-[40px] font-bold leading-[140%] mt-3 max-[744px]:text-left max-[744px]:text-[32px] max-[465px]:text-2xl">
              구매를 원하는
              <br />
              상품을 검색하세요
            </p>
            <p className="inline text-right text-gray-700 text-2xl font-medium leading-8 mt-6 max-[744px]:text-left max-[744px]:text-xl max-[465px]:text-base">
              구매하고 싶은 물품은 검색해서
              <br />
              쉽게 찾아보세요
            </p>
