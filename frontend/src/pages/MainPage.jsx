import top from "../assets/Img_home_top.png";
import hot from "../assets/Img_home_01.png";
import search from "../assets/Img_home_02.png";
import register from "../assets/Img_home_03.png";
import bottom from "../assets/Img_home_bottom.png";
         ...
         <section className="hot-item">
            <div className="hot-item-container">
               ...
               <div className="hot-item-text-container">
                  <div className="hot-item-badge">Hot item</div>
         ...
         <section className="search">
            <div className="search-container">
               <div className="search-text-container">
                  <div className="search-badge">Search item</div>
         ...
         <section className="register">
            <div className="register-container">
               ...
               <div className="register-text-container">
                  <div className="register-badge">Register</div>
