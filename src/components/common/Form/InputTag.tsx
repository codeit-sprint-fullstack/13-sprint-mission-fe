...
interface InputTagProps extends Omit<
...
export default function InputTag({
  ...
  const inputRef = useRef<HTMLInputElement>(null); // 인풋창 초기화 및 포커스를 위한 Ref

  const [tags, setTags] = useState<string[]>(defaultValue); // 현재 등록된 태그들의 문자열 배열
  const [inputText, setInputText] = useState<string>(""); // 사용자가 현재 입력 중인 텍스트
