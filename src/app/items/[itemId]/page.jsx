...
const shellClass =
  "mx-auto w-[min(100%-32px,640px)] tablet:w-[min(100%-48px,90px)] desktop:w-[min(100%-48px,1120px)]";
...
export default function ItemDetailPage() {
  ...
  return (
    <div className="bg-white text-[#1f2937]">
      <Header />
      <main
        className={`${shellClass} min-h-[calc(100vh-170px)] pb-[130px] pt-[34px]`}
      >
                ...
                <div className="mt-[42px] flex flex-col items-start justify-between gap-[18px] desktop:flex-row desktop:items-center">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>
                      ...
                      <small className="mt-1 block text-xs text-grat-400">
                        {formattedDate}
                      </small>
                    </span>
                  </div>
                  <button
                    className={`inline-flex min-h-[42px] items-center gap-[7px] rounded-full border px-[18px] ${
                      product.isFavorite
                        ? "border-red-200 bg-rose-50 text-[#ef4444]"
