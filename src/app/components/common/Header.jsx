      ...
      >
        ...
        >
          <Image
            ...
            width={40}
            height={40}
            className="shrink-0 max-[343px]:w-7 max-[343px]:h-7"
          />
          <span
            className="text-[#3692FF] text-[25.633px] font-bold whitespace-nowrap max-[343px]:text-lg"
        ...
        <div className="flex flex-1">
          <Link
            href="/community"
            className={`text-center text-lg font-bold leading-6.5 no-underline whitespace-nowrap max-[343px]:text-sm ${
        ...
        <button
          type="button"
          className="inline-flex h-10.5 max-[343px]:h-9 justify-center items-center border-none rounded-lg text-white text-base font-semibold cursor-pointer bg-[#3692FF] whitespace-nowrap max-[343px]:text-sm"
