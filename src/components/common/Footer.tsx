...
import { SOCIAL_CONFIG, WIDTH_HEADER_LIST } from "@/lib/constants/constants";
...
export default function Footer() {
  ...
  return (
    <footer className='h-[160px]'>
      <div className='fixed bottom-0 left-0 right-0 z-footer bg-secondary-900'>
        <div className='flex flex-wrap md:flex-nowrap justify-between gap-x-[20px] gap-y-[24px] md:gap-y-0 w-full h-[160px] max-w-[1200px] px-[16px] md:px-[24px] xl:px-[200px] py-[32px] mx-auto'>
