      ...
      <div className="flex w-[640px] flex-col items-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-[58px] flex w-full flex-col">
          <div className="flex flex-col">
            <label className="font-['Pretendard'] text-[18px] font-bold leading-[26px] text-[#1F2937]">이메일</label>
            <input
              type="email"
              {...register("email", {
          ...
          <div className="mt-[24px] flex flex-col">
            <label className="font-['Pretendard'] text-[18px] font-bold leading-[26px] text-[#1F2937]">비밀번호</label>
            <div className="relative mt-[16px] w-full">
              <input
                ...
                className={`h-[56px] w-[640px] rounded-[12px] bg-[#F3F4F6] px-[24px] py-[16px] font-['Pretendard'] text-[16px] outline-none transition-colors ${errors.password ? "border border-[#F74747]" : "border border-transparent focus:border-[#3692FF]"}`}
              />
          ...
          <button
            ...
            className={`mt-[24px] flex h-[56px] w-[640px] items-center justify-center rounded-[40px] px-[124px] py-[16px] font-['Pretendard'] text-[18px] font-bold text-white transition-colors ${isValid ? "bg-[#3692FF] hover:bg-blue-600" : "bg-[#9CA3AF] cursor-not-allowed"}`}
          >
        ...
        <div className="mt-[24px] flex items-center justify-center gap-[4px]">
          <span className="font-['Pretendard'] text-[14px] font-medium leading-[24px] text-[#1F2937]">판다마켓이 처음이신가요?</span>
          <Link href="/signup" className="font-['Pretendard'] text-[14px] font-medium text-[#3692FF] underline decoration-solid underline-offset-4">회원가입</Link>
        </div>
      </div>
