...
function Header() {
    ...
    const t1 = isFreeboard ? "text-blue-500" : "";
    let t2;
    if ($[2] !== t1) {
    ...
    if ($[5] !== t2) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
            className: "order-3 flex w-full flex-1 items-center gap-5 text-[15px] font-bold text-gray-700 sm:order-none sm:w-auto sm:gap-8",
            children: [
                t2,
                t3
            ]
...
//# sourceMappingURL=src_components_Header_19ck1jb.js.map