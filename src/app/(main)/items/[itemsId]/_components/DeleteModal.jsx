    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="flex w-[298px] flex-col items-center gap-8 rounded-2xl bg-white p-6">
        ...
        <div className="flex w-[184px] gap-2">
          <button
            onClick={onCancel}
            className="border-error text-error h-12 flex-1 rounded-xl border text-lg font-semibold"
          >
            취소
          </button>
          <button
            onClick={onConfirm}
            className="bg-error h-12 flex-1 rounded-xl text-lg font-semibold text-white"
          >
            네
          </button>
        </div>
