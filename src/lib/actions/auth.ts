...
export async function getCurrentUserId() {
  ...
  try {
    return jwtDecode<AppJwtPayload>(token).userId ?? null;
  } catch {
    return null;
  }
}
...
/** 로그인 액션 */
export async function signinAction(formData: SigninPayload) {
...
/** 회원가입 액션 */
export async function signupAction(formData: SignupPayload) {
