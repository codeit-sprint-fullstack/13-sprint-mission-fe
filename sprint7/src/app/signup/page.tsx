      ...
      <div className="flex w-[640px] flex-col items-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-[40px] flex w-full flex-col">
          ...
          <div className="flex flex-col">
            <label className="font-['Pretendard'] text-[18px] font-bold text-[#1F2937]">
              이메일
            </label>
            <input
              type="email"
              ...
              className={`mt-[16px] h-[56px] w-full rounded-[12px] bg-[#F3F4F6] px-[24px] py-[16px] font-['Pretendard'] text-[16px] outline-none transition-colors ${
          ...
          <div className="mt-[24px] flex flex-col">
            ...
            <input
              ...
              className={`mt-[16px] h-[56px] w-full rounded-[12px] bg-[#F3F4F6] px-[24px] py-[16px] font-['Pretendard'] text-[16px] outline-none transition-colors ${
                errors.nickname ? "border border-[#F74747]" : "border border-transparent focus:border-[#3692FF]"
              }`}
            />
            {errors.nickname && (
              <span className="mt-[8px] font-['Pretendard'] text-[14px] font-semibold leading-[24px] text-[#F74747]">
          ...
          <div className="mt-[24px] flex flex-col">
            ...
            <div className="relative mt-[16px] w-full">
              <input
                ...
                className={`h-[56px] w-full rounded-[12px] bg-[#F3F4F6] px-[24px] py-[16px] pr-[48px] font-['Pretendard'] text-[16px] outline-none transition-colors ${
          ...
          <div className="mt-[24px] flex flex-col">
            ...
            <div className="relative mt-[16px] w-full">
              <input
                ...
                className={`h-[56px] w-full rounded-[12px] bg-[#F3F4F6] px-[24px] py-[16px] pr-[48px] font-['Pretendard'] text-[16px] outline-none transition-colors ${
                  errors.passwordConfirm ? "border border-[#F74747]" : "border border-transparent focus:border-[#3692FF]"
                }`}
              />
          ...
          <button
            ...
            className={`mt-[24px] flex w-full items-center justify-center rounded-[40px] px-[124px] py-[16px] font-['Pretendard'] text-[20px] font-semibold leading-[24px] text-white transition-colors ${
        ...
        <div className="mt-[24px] flex items-center justify-center gap-[4px]">
          ...
          <Link href="/signin" className="font-['Pretendard'] text-[15px] font-medium text-[#3182F6] underline decoration-solid underline-offset-4">
            로그인
          </Link>
        </div>
      </div>
