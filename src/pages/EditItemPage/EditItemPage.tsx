...
import type { UpdateProductInput } from "../../types/models";
...
function EditItemPage() {
  ...
  const updateProductMutation = useMutation({
    mutationFn: (product: UpdateProductInput) => patchProduct(productId!, product),
    onSuccess: (product) => {
  ...
  useEffect(() => {
    ...
    form.resetForm({ name, description, price: String(price), images, tags });
