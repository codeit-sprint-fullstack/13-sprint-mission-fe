...
import type { AuthFormValues, AuthResponse } from "@/types/api";
  ...
  return (
    <AuthShell>
      <form className="w-full" onSubmit={onSubmit}>
        ...
        <button
          className="mt-0.5 inline-flex h-[48px] w-full items-center justify-center rounded-full bg-gray-400 px-[18px] text-[15px] font-bold text-white enabled:bg-[#3692ff] disabled:cursor-not-allowed disabled:opacity-70"
          type="submit"
      ...
      <div className="mt-[18px] flex min-h-14 w-full items-center justify-between rounded-lg bg-blue-50 px-[72px] text-[13px] font-bold">
        <span>간편 로그인하기</span>
