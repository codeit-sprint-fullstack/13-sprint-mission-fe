...
export default function ProductCard({ item, onToggleLike }: ProductCardProps) {
  return (
    <Link href={`/items/${item.id}`}>
      <div className="flex w-full flex-col gap-2">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="text-lg font-bold text-gray-800">{item.price.toLocaleString("ko-KR")}원</div>
          <button
            onClick={(e) => {
              e.preventDefault();
