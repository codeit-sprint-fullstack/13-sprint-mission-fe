  ...
  return (
    <div className="flex items-center justify-center h-fit">
      ...
      >
        ...
        <div className="flex w-fit flex-col justify-center items-end mr-[31px] px-[30px] max-desktop:p-0">
          <div className="flex flex-col gap-[12px] whitespace-pre-wrap items-end text-end">
            <p className="text-[18px] font-bold text-[var(--primary-100)]">
              {tag}
            </p>

            <h3 className="text-[40px] font-bold leading-[140%] text-[var(--secondary-700)] max-[720px]:text-[35px]">
              {title}
            </h3>

            <p className="break-keep text-[24px] font-medium leading-[32px] text-[var(--secondary-700)] max-[720px]:text-[20px]">
              {text}
            </p>
          </div>
        </div>
